...
OPTIONAL_DEPENDENCIES = {
    ...
    "dnacurve": "Validated curvature output is marked unavailable; legacy dinucleotide screens remain separately named.",
    "rpy2": "DNAshapeR-backed shape output is marked unavailable; no heuristic is substituted under predictor-backed fields.",
