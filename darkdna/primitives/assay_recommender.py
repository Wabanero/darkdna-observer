...
MECHANISTIC_BRIDGES: dict[str, dict] = {
    ...
    "periodic_spacing_grammar_candidate": _bridge(
        "10 bp/147 bp periodicity, spacing Fourier power, or spacing autocorrelation",
        "nucleosome phasing, cooperative spacing, or other spacing-dependent molecular readout",
        [
            "nucleosome phasing",
            "TF cooperative binding at phased spacing",
            "DNA shape periodicity",
            "replication dynamics",
        ],
        [
            "show periodicity affects an intermediate molecular process",
            "compare phase-scrambled and periodicity-disrupted controls",
            "do not interpret pulse decoding or locus motion from sequence periodicity alone",
        ],
    ),
    "asymmetric_repeat_architecture_candidate": _bridge(
        "left/right GC asymmetry, nested repeats, or recurrent-k-mer orientation",
        "orientation- or nest-dependent chromatin, binding, or structural readout",
        [
            "secondary-structure orientation",
            "repeat-order chromatin context",
            "cooperative binding along an oriented repeat",
        ],
        [
            "separate orientation/nesting from simple repeat content",
            "use orientation-inverted and nest-disrupted controls",
            "do not interpret hysteresis or memory from static asymmetry",
        ],
    ),
...
ASSAY_BLUEPRINTS: dict[str, dict] = {
    ...
    "periodic_spacing_grammar_candidate": {
        "assay": "Periodicity phase-scramble tiling assay",
        "sequence_controls": ["native", "phase-scrambled", "periodicity-disrupted", "GC-matched", "motif-preserved spacing-randomized"],
        "perturbations": ["baseline", "mild stress"],
        "readouts": ["nucleosome positioning", "DNA shape", "protein occupancy", "reporter output"],
        "classical_validation": ["tiling MPRA", "MNase or nucleosome occupancy"],
        "key_interaction_test": "periodicity_effect = (Native_spacing_dependent_readout - PhaseScrambled_readout) - (PeriodicityDisrupted_readout - LengthMatchedControl_readout)",
    },
    "asymmetric_repeat_architecture_candidate": {
        "assay": "Orientation and nested-repeat disruption assay",
        "sequence_controls": ["native", "orientation-inverted", "nest-disrupted", "repeat-content-matched scramble", "GC-matched control"],
        "perturbations": ["baseline", "mild stress"],
        "readouts": ["structural state", "nucleosome positioning", "repeat-orientation occupancy", "reporter output"],
        "classical_validation": ["tiling reporter with orientation and nest controls"],
        "key_interaction_test": "orientation_or_nest_effect = (Native_readout - OrientationInverted_readout) - (NestDisrupted_readout - RepeatContentMatched_readout)",
    },
