...
PRIMITIVE_TRACKS = {
    ...
    "periodic_spacing_grammar_candidate": "periodic_spacing_grammar_candidates.bed",
    "asymmetric_repeat_architecture_candidate": "asymmetric_repeat_architecture_candidates.bed",
